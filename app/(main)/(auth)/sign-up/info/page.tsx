...
//
//         try {
//             // TODO: call API register/complete profile
//             const result = await signUpAction(password);
//              if(result.success) {
...
//                     <span style={styles.title}>SET PASSWORD</span>
//                 </div>
//
//                 <div style={styles.infoBox}>
//                     Please set your password to complete sign up.
//                 </div>
//
//                 {/* PASSWORD */}
...
export default function InfoPafe() {
  return (
    <div>
      Hi
    </div>
